...
PROVIDERS = [
    ...
    ["P-16", "NPC — National Statistics Office: Economic Surveys & Large-Case Profiling",
     "Internal — NPC", "INTERNAL — NPC (Statistics & Surveys)", "Tier 3", "—",
    ...
    ["P-17", "NPC — National Statistics Office: Statistical Business Register (SBR)",
     "Internal — NPC", "INTERNAL — NPC (Statistics & Surveys)", "Tier 3", "—",
    ...
    ["P-18", "NPC — National Statistics Office: Classification portal (manual / committee)",
     "Internal — NPC", "INTERNAL — NPC (Statistics & Surveys)", "Tier 3", "—",
...
RACI = [
 ["Own the methodology", "NPC — NSO", "NPC Council", "Methodologist", "All agencies"],
 ["Provide source data", "MoCI / GTA / QCB / QFC / QFZA / MoL / MoF / MoJ", "NPC — NSO", "Data Steward", "TCC"],
...
def build():
    ...
    notes = [
        ...
        ("• 'Provider register' lists every entity that must supply data. Filter the 'Source bucket' column to separate EXTERNAL ministries/authorities from INTERNAL NPC (Statistics & Surveys) sources.", False),
        ...
        "",
        ("Terminology note — 'NPC'", True),
        ("• Internal sources are the National Statistics Office functions under the NPC — including the Economic Surveys / large-case profiling department. They are tagged 'INTERNAL — NPC (Statistics & Surveys)'.", False),
        "",
